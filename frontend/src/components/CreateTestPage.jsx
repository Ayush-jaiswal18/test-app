                    ...
                    section.questions.map((question, qIndex) => (
                      <div key={qIndex} className="mb-4 p-4 border rounded-lg bg-white">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              if (newType === 'true-false') {
                                ...
                                // Clear options/answers as they are not needed
                                handleQuestionChange(sIndex, qIndex, 'options', []);
                                handleQuestionChange(sIndex, qIndex, 'correctAnswer', null);
                              }
                            }}
                            className="w-full p-2 border rounded"
                          >
                        ...
                        {question.questionType === 'image-based' && (
                          <div className="mb-3">
                            <label className="block text-gray-700 text-sm font-semibold mb-2">Image URL or Upload:</label>
                            <div className="flex gap-2 mb-2">
                              ...
                              />
                              <label className="bg-blue-600 text-white px-3 py-2 rounded hover:bg-blue-700 cursor-pointer text-sm flex items-center">
                                Upload
                                <input
                                  type="file"
                                  accept="image/*"
              ...
              <div className="p-6 border-b">
                ...
                <div className="flex mt-4 border-b">
                  <button
                    ...
                    className={`px-4 py-2 font-medium text-sm border-b-2 transition ${extractionTab === 'mcq'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 font-medium text-sm border-b-2 transition ${extractionTab === 'coding'
                  ...
                  <div className="space-y-3">
                    {extractedQuestions.length === 0 ? (
                      ...
                      extractedQuestions.map((eq, index) => (
                        <div
                          key={index}
                          className={`p-4 border-2 rounded-lg cursor-pointer transition ${selectedExtractedQuestions.includes(index)
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className={`text-xs px-2 py-0.5 rounded ${eq.type === 'mcq' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                                  }`}>
                              ...
                              {eq.options && eq.options.length > 0 && (
                                <div className="mt-2 pl-4 space-y-1">
                                  {eq.options.map((opt, optIndex) => (
                                    <div
                                      key={optIndex}
                                      className={`text-sm flex items-center gap-1 ${eq.correctAnswer === optIndex
                  ...
                  <div className="space-y-4">
                    {extractedCodingQuestions.length === 0 ? (
                      ...
                      extractedCodingQuestions.map((cq, index) => (
                        <div
                          key={index}
                          className={`p-4 border-2 rounded-lg cursor-pointer transition ${selectedExtractedCodingQuestions.includes(index)
              ...
              <div className="p-6 border-t bg-gray-50 flex justify-between items-center">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-white transition ${(selectedExtractedQuestions.length > 0 || selectedExtractedCodingQuestions.length > 0)
